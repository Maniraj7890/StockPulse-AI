...
function LosersTable({ rows }) {
  return (
    <div className="panel p-5">
      <p className="metric-label">Pressure</p>
      <h3 className="mt-2 font-display text-xl font-bold text-white">Top losers</h3>
          ...
          <div key={stock.symbol} className="rounded-2xl border border-border/60 bg-panel-soft/60 px-4 py-3">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-rose-300">{formatPercent(quote.changePercent ?? stock.dayChangePercent)}</p>
